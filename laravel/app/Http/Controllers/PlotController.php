    ...
    */
    ...
    function EcgPlot($hexs, $id)
    {
      ...
      */
      ...
      imagepng($image, '/var/www/laravel/storage/images/' . $id . '.png');
      imagepng($image);
      imagedestroy($image);
    }
    ...
    function CheckmeO2Plot($hexs, $id)
    {
      ...
      imagefill($image, 0, 0, $white);
      imagefttext($image, 100, 0, 50, 620, $green, '/var/www/laravel/app/Http/Controllers/consola.ttf', "SpO2");
      imagefttext($image, 100, 0, 3200, 620, $blue, '/var/www/laravel/app/Http/Controllers/consola.ttf', "Heart Rate");
      imagefttext($image, 100, 0, 1800, 480, $yellow, '/var/www/laravel/app/Http/Controllers/consola.ttf', "Motion");
      ...
      imagefttext($image, 50, 0, 50, 824, $green, '/var/www/laravel/app/Http/Controllers/consola.ttf', "100%");
      imagefttext($image, 50, 0, 3800, 824, $blue, '/var/www/laravel/app/Http/Controllers/consola.ttf', "170");
      imageline($image, 200, 800 + 2000/7, 3800, 2000/7 + 800, $grey);
      imagefttext($image, 50, 0, 50, 2000/7 + 824, $green, '/var/www/laravel/app/Http/Controllers/consola.ttf', "95%");
      imagefttext($image, 50, 0, 3800, 824 + 2000/7, $blue, '/var/www/laravel/app/Http/Controllers/consola.ttf', "150");
      imageline($image, 200, 800 + 2*2000/7, 3800, 2*2000/7 + 800, $grey);
      imagefttext($image, 50, 0, 50, 2*2000/7 + 824, $green, '/var/www/laravel/app/Http/Controllers/consola.ttf', "90%");
      imagefttext($image, 50, 0, 3800, 824 + 2*2000/7, $blue, '/var/www/laravel/app/Http/Controllers/consola.ttf', "130");
      imageline($image, 200, 800 + 3*2000/7, 3800, 3*2000/7 + 800, $grey);
      imagefttext($image, 50, 0, 50, 3*2000/7 + 824, $green, '/var/www/laravel/app/Http/Controllers/consola.ttf', "85%");
      imagefttext($image, 50, 0, 3800, 824 + 3*2000/7, $blue, '/var/www/laravel/app/Http/Controllers/consola.ttf', "110");
      imageline($image, 200, 800 + 4*2000/7, 3800, 4*2000/7 + 800, $grey);
      imagefttext($image, 50, 0, 50, 4*2000/7 + 824, $green, '/var/www/laravel/app/Http/Controllers/consola.ttf', "80%");
      imagefttext($image, 50, 0, 3800, 824 + 4*2000/7, $blue, '/var/www/laravel/app/Http/Controllers/consola.ttf', "90");
      imageline($image, 200, 800 + 5*2000/7, 3800, 5*2000/7 + 800, $grey);
      imagefttext($image, 50, 0, 50, 5*2000/7 + 824, $green, '/var/www/laravel/app/Http/Controllers/consola.ttf', "75%");
      imagefttext($image, 50, 0, 3800, 824 + 5*2000/7, $blue, '/var/www/laravel/app/Http/Controllers/consola.ttf', "70");
      imageline($image, 200, 800 + 6*2000/7, 3800, 6*2000/7 + 800, $grey);
      imagefttext($image, 50, 0, 50, 6*2000/7 + 824, $green, '/var/www/laravel/app/Http/Controllers/consola.ttf', "70%");
      imagefttext($image, 50, 0, 3800, 824 + 6*2000/7, $blue, '/var/www/laravel/app/Http/Controllers/consola.ttf', "50");
      imageline($image, 200, 800 + 2000, 3800, 2800, $grey);
      imagefttext($image, 50, 0, 50, 2824, $green, '/var/www/laravel/app/Http/Controllers/consola.ttf', "65%");
      imagefttext($image, 50, 0, 3800, 2824, $blue, '/var/www/laravel/app/Http/Controllers/consola.ttf', "30");
