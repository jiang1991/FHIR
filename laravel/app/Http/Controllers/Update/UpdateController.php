...
class UpdateController extends Controller
{
  ...
  function update()
  {
    $response["o2"]["0"]["version"] = "0.6.1";
    $response["o2"]["0"]["hardware_version"] = "AA";
    $response["o2"]["0"]["model"] = "1611";
    $response["o2"]["0"]["region"] = "FDA";
    $response["o2"]["0"]["fileLocate"] = "http://api.viatomtech.com.cn/download/software/FDA_1611_AA_061.bin";
    $response["o2"]["1"]["version"] = "0.6.1";
    $response["o2"]["1"]["hardware_version"] = "BB";
    $response["o2"]["1"]["model"] = "1611";
    $response["o2"]["1"]["region"] = "FDA";
    $response["o2"]["1"]["fileLocate"] = "http://api.viatomtech.com.cn/download/software/FDA_1611_BB_061.bin";
