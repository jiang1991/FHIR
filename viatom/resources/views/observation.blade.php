    ...
    <div class="col-md-10 col-md-offset-1">
      ...
      <div class="panel panel-default"> 
        ...
        <div class="panel-body">
          <!-- export as pdf -->
          <div>
            <a href="/export/observation/{{ $observation->id }}" role="button" class="btn btn-primary" data-toggle="tooltip" data-placement="right" title="Export PDF report."><span class="glyphicon glyphicon-download-alt" aria-hidden="true"></span> Export as PDF</a>
            <!-- export as excel -->
            <a href="/export/excel/observation/{{ $observation->id }}" role="button" class="btn btn-primary" data-toggle="tooltip" data-placement="right" title="Export Excel report, for professional use."><span class="glyphicon glyphicon-download-alt" aria-hidden="true"></span> Export as Excel</a>
          </div>
