      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
            ...
            <div class="form-group{{ $errors->has('check_terms') ? ' has-error' : '' }}">
              <div class="col-md-6 col-md-offset-4">
                <div class="checkbox">
                  <label>
                    <input type="checkbox" name="check_terms"> I agree to the Viatom <a href="{{ url('/terms') }}">Terms</a> and <a href="{{ url('/privacy') }}">Privacy Policy</a> in particular.
                  </label>
                </div>
              </div>
            </div>

            <div class="form-group{{ $errors->has('check_privacy') ? ' has-error' : '' }}">
              <div class="col-md-6 col-md-offset-4">
                <div class="checkbox">
                  <label>
                    <input type="checkbox" name="check_privacy">I consent to the collection, processing and disclosure of my de-identified heart activity data and related health information by Viatom as described in the <a href="{{ url('/privacy') }}">Privacy Policy</a>. I have the right to withdraw my consent at any time, as described in the <a href="{{ url('/privacy') }}">Privacy Policy</a>.
                  </label>
                </div>
              </div>
            </div>
