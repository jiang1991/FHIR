...
class PlotController extends Controller
{
  public function Plot($id)
  {
    ...
    $timeStr = Observation::find(Observation_component::find($id)->observation_id)->effectiveDateTime;
    ...
    */
    ...
    function CheckmeO2Plot($hexs, $id, $time)
    {
      $d = strtotime($time);
      ...
      // shart time & end time
      imagefttext($image, 50, 0, 110, 2900, $black, '/var/www/cloud/app/Http/Controllers/consola.ttf', date("H:i", $d));
      imagefttext($image, 50, 0, 110 + 3600/5, 2900, $black, '/var/www/cloud/app/Http/Controllers/consola.ttf', date("H:i", $d1));
      imagefttext($image, 50, 0, 110 + 3600/5*2, 2900, $black, '/var/www/cloud/app/Http/Controllers/consola.ttf', date("H:i", $d2));
      imagefttext($image, 50, 0, 110 + 3600/5*3, 2900, $black, '/var/www/cloud/app/Http/Controllers/consola.ttf', date("H:i", $d3));
      imagefttext($image, 50, 0, 110 + 3600/5*4, 2900, $black, '/var/www/cloud/app/Http/Controllers/consola.ttf', date("H:i", $d4));
      imagefttext($image, 50, 0, 3710, 2900, $black, '/var/www/cloud/app/Http/Controllers/consola.ttf', date("H:i", $d5));
