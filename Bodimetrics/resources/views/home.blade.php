                ...
                <td>
                  <table>
                    <tr>
                      ...
                      <h3><a href="/mypatient/{{ $patient->id }}">  <u>{{ $patient->name }}</u>  </a></h3>
                      <div class="row">
                        <div class="col-md-4 text-danger"><strong>ID# {{ $patient->medicalId }}</strong></div>
                        <div class="col-md-4 text-danger"><strong>SN: {{ $patient->identifier_value }}</strong> </div>

                        @if ($patient->gender == "--")
                        @else
                        <div class="col-md-2 text-capitalize">Gender: {{ $patient->gender }}</div>
                        @endif
                  ...
                  <table>
                    <tr>
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-4 text-danger"><strong>ID# {{ $sharePatient->medicalId }}</strong> </div>

                        <div class="col-md-4 text-danger"><strong>SN: {{ $sharePatient->identifier_value }}</strong></div>

                        @if ($sharePatient->gender == "--")
                        @else
                        <div class="col-md-2 text-capitalize">Gender: {{ $sharePatient->gender }}</div>
                        @endif
